...
?>
<nav class="woocommerce-products-wizard-nav is-tabs <?php echo esc_attr(implode(' ', $class))?>"<?php
    ...
    <ul class="woocommerce-products-wizard-nav-list is-tabs nav nav-tabs" data-component="wcpw-nav-list" role="tablist">
        <?php
