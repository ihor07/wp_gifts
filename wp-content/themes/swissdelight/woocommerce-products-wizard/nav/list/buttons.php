...
?>
<nav class="woocommerce-products-wizard-nav is-buttons <?php echo esc_attr(implode(' ', $class))?>"<?php
    ...
    <ul class="woocommerce-products-wizard-nav-list is-buttons nav" data-component="wcpw-nav-list" role="tablist">
        <?php
