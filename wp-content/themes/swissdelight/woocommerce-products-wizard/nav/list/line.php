...
?>
<nav class="woocommerce-products-wizard-nav is-line <?php echo esc_attr(implode(' ', $class))?>"<?php
    ...
    <ul class="woocommerce-products-wizard-nav-list is-line" data-component="wcpw-nav-list" role="tablist">
        <?php
