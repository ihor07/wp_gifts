<?php if ( isset( $query_result ) && intval( $query_result->max_num_pages ) > 1 ) { ?>
	<div class="qodef-m-pagination qodef--load-more" <?php swissdelight_is_installed( 'framework' ) ? qode_framework_inline_style( $pagination_type_load_more_top_margin ) : ''; ?>>
		<div class="qodef-m-pagination-inner">
			...
			$button_params = array(
				...
				'link'          => '#',
				'text'          => esc_html__( 'Load More', 'swissdelight' ),
			);
