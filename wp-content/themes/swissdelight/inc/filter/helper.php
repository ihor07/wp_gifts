...
if ( ! function_exists( 'swissdelight_get_filter_items' ) ) {
	/**
	 ...
	 * @return array
	 */
	function swissdelight_get_filter_items( $params ) {
		...
		return apply_filters( 'swissdelight_filter_get_filter_items', $items, $params );
	}
}
