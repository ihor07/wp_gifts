...
if ( ! function_exists( 'swissdelight_core_add_administrator_role_caps' ) ) {
	/**
	 * Function that add user role capabilities for custom post types
	 */
	function swissdelight_core_add_administrator_role_caps() {

		// Add the roles you'd like to administer the custom post types
		$roles = apply_filters( 'swissdelight_core_filter_administrator_roles', array( 'editor', 'administrator' ) );

		// Allowed custom post types
		$cpt_items = apply_filters( 'swissdelight_core_filter_administrator_cpts', array() );
	...
	add_action( 'swissdelight_core_action_plugin_loaded', 'swissdelight_core_add_administrator_role_caps' );
}
