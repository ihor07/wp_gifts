...
if ( ! class_exists( 'SwissDelightCore_Dashboard_Rest_API' ) ) {
	 ...
	 */
	class SwissDelightCore_Dashboard_Rest_API {
		...
		public function __construct() {
			...
			add_filter( 'swissdelight_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
		...
		/**
		 * @return SwissDelightCore_Dashboard_Rest_API
		 */
	...
	SwissDelightCore_Dashboard_Rest_API::get_instance();
}
