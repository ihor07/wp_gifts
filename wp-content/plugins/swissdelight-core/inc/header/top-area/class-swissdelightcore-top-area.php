...
class SwissDelightCore_Top_Area {
	...
	public function __construct() {
		...
		add_action( 'swissdelight_action_before_page_header', array( $this, 'load_template' ) );
		...
		add_filter( 'swissdelight_filter_add_inline_style', array( $this, 'set_inline_top_area_styles' ) );
		add_filter( 'swissdelight_core_filter_top_area_inner_class', array( $this, 'set_inline_top_area_class' ) );
	}

	/**
	 * @return SwissDelightCore_Top_Area
	 */
	...
	function is_top_area_enabled() {
		$top_area_enabled = 'yes' === swissdelight_core_get_post_value_through_levels( 'qodef_top_area_header' );
	...
	public function set_top_area_height() {
		if ( $this->is_top_area_enabled ) {
			$height         = swissdelight_core_get_post_value_through_levels( 'qodef_top_area_header_height' );
	...
	public function is_top_area_transparent() {
		$background_color = swissdelight_core_get_post_value_through_levels( 'qodef_top_area_header_background_color' );
	...
	public function load_template() {
		...
		swissdelight_core_template_part( 'header/top-area/', 'templates/top-area', '', $parameters );
	}
	...
	public function set_inline_top_area_styles( $style ) {
		...
		$height       = swissdelight_core_get_post_value_through_levels( 'qodef_top_area_header_height' );
		$side_padding = swissdelight_core_get_post_value_through_levels( 'qodef_top_area_header_side_padding' );
	...
	public function set_inline_top_area_class( $class ) {
		$skin = swissdelight_core_get_post_value_through_levels( 'qodef_top_area_header_skin' );

		$class .= 'yes' === swissdelight_core_get_post_value_through_levels( 'qodef_top_area_header_in_grid' ) ? 'qodef-content-grid' : '';
		$class .= ! empty( $skin ) ? ' qodef-skin--' . $skin : '';

		return $class;
	}
}

SwissDelightCore_Top_Area::get_instance();
