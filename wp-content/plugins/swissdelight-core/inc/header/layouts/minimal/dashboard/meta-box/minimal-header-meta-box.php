...
if ( ! function_exists( 'swissdelight_core_add_minimal_header_meta' ) ) {
	/**
	 * Function that add additional header layout meta box options
	 *
	 * @param object $page
	 */
	function swissdelight_core_add_minimal_header_meta( $page ) {
	...
	add_action( 'swissdelight_core_action_after_page_header_meta_map', 'swissdelight_core_add_minimal_header_meta' );
}
