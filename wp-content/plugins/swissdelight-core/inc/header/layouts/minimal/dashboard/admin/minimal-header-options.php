...
if ( ! function_exists( 'swissdelight_core_add_minimal_header_options' ) ) {
	/**
	 ...
	 */
	function swissdelight_core_add_minimal_header_options( $page, $general_header_tab ) {

		$section = $general_header_tab->add_section_element(
			array(
				'name'       => 'qodef_minimal_header_section',
				'title'      => esc_html__( 'Minimal Header', 'swissdelight-core' ),
				'dependency' => array(
					'show' => array(
	...
	add_action( 'swissdelight_core_action_after_header_options_map', 'swissdelight_core_add_minimal_header_options', 10, 2 );
}
