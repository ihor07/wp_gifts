...
class SwissDelightCore_Standard_Header extends SwissDelightCore_Header {
	...
	/**
	 * @return SwissDelightCore_Standard_Header
	 */
	...
	function get_menu_position() {
		return swissdelight_core_get_post_value_through_levels( 'qodef_standard_header_menu_position' );
	}
