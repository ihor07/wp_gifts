<?php
$is_enabled = swissdelight_core_get_post_value_through_levels( 'qodef_blog_single_enable_author_info' );

if ( 'yes' === $is_enabled && '' !== get_the_author_meta( 'description' ) ) {
	$author_id     = get_the_author_meta( 'ID' );
	$author_link   = get_author_posts_url( $author_id );
	$email_enabled = 'yes' === swissdelight_core_get_post_value_through_levels( 'qodef_blog_single_enable_author_info_email' );
