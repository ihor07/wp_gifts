...
if ( ! function_exists( 'swissdelight_core_add_portfolio_archive_sidebar_options' ) ) {
	/**
	 * Function that add sidebar options for portfolio archive module
	 */
	function swissdelight_core_add_portfolio_archive_sidebar_options( $tab ) {
		...
		if ( $tab ) {
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose default sidebar layout for portfolio archives', 'swissdelight-core' ),
			...
			if ( ! empty( $custom_sidebars ) && count( $custom_sidebars ) > 1 ) {
				$tab->add_field_element(
					array(
						...
						'description' => esc_html__( 'Choose a custom sidebar to display on portfolio archives', 'swissdelight-core' ),
	...
	add_action( 'swissdelight_core_action_after_portfolio_options_archive', 'swissdelight_core_add_portfolio_archive_sidebar_options' );
}

if ( ! function_exists( 'swissdelight_core_add_portfolio_single_sidebar_options' ) ) {
	/**
	 * Function that add sidebar options for portfolio single module
	 */
	function swissdelight_core_add_portfolio_single_sidebar_options( $tab ) {
	...
	add_action( 'swissdelight_core_action_after_portfolio_options_single', 'swissdelight_core_add_portfolio_single_sidebar_options' );
}
