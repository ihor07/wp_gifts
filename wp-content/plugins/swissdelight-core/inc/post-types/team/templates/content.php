...
do_action( 'swissdelight_core_action_before_team_content_holder' );
?>
	<main id="qodef-page-content" class="qodef-grid qodef-layout--template <?php echo esc_attr( swissdelight_core_get_grid_gutter_classes() ); ?>">
		<div class="qodef-grid-inner clear">
			...
			swissdelight_core_template_part( 'post-types/team', 'templates/team', $content );
...
do_action( 'swissdelight_core_action_after_team_content_holder' );
?>
