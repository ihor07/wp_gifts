...
if ( ! class_exists( 'SwissDelightCore_Shortcodes' ) ) {
	class SwissDelightCore_Shortcodes {
		...
		/**
		 * @return SwissDelightCore_Shortcodes
		 */
		...
		function init() {
			...
			include_once SWISSDELIGHT_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once SWISSDELIGHT_CORE_SHORTCODES_PATH . '/class-swissdelightcore-shortcode.php';
			include_once SWISSDELIGHT_CORE_SHORTCODES_PATH . '/class-swissdelightcore-list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'swissdelight_core_filter_register_shortcodes', $shortcodes = array() );
	...
	SwissDelightCore_Shortcodes::get_instance();
}
