...
class SwissDelightCoreElementorWorkflow extends \Elementor\Widget_Base{
	...
	public function set_object(){
		$this->object = qode_framework_get_framework_root()->get_shortcodes()->get_shortcode('swissdelight_core_workflow');
	}
...
swissdelight_core_get_elementor_widgets_manager()->register_widget_type( new SwissDelightCoreElementorWorkflow() );