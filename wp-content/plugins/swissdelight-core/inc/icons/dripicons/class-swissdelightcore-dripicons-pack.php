...
if ( ! function_exists( 'swissdelight_core_add_dripicons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function swissdelight_core_add_dripicons_to_collection( $icons ) {
		$icons[] = 'SwissDelightCore_Dripicons_Icon_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'swissdelight_core_add_dripicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class SwissDelightCore_Dripicons_Icon_Pack extends QodeFrameworkIconPack {
