...
if ( ! function_exists( 'swissdelight_core_add_material_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function swissdelight_core_add_material_icons_to_collection( $icons ) {
		$icons[] = 'SwissDelightCore_Material_Icons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'swissdelight_core_add_material_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class SwissDelightCore_Material_Icons_Pack extends QodeFrameworkIconPack {
