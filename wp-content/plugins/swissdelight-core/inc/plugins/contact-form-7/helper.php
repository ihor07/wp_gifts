...
if ( ! function_exists( 'swissdelight_core_get_contact_form_7_forms' ) ) {
	/**
	 ...
	 * @return array
	 */
	function swissdelight_core_get_contact_form_7_forms() {
		$options       = array();
		...
		if ( ! empty( $contact_forms ) ) {
			...
			$options[0] = esc_html__( 'No contact forms found', 'swissdelight-core' );
		}
