...
if ( ! function_exists( 'swissdelight_core_add_twitter_list_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function swissdelight_core_add_twitter_list_shortcode( $shortcodes ) {
		if ( qode_framework_is_installed( 'twitter' ) ) {
			$shortcodes[] = 'SwissDelightCore_Twitter_List_Shortcode';
		}

		return $shortcodes;
	}

	add_filter( 'swissdelight_core_filter_register_shortcodes', 'swissdelight_core_add_twitter_list_shortcode' );
}

if ( class_exists( 'SwissDelightCore_List_Shortcode' ) ) {
	class SwissDelightCore_Twitter_List_Shortcode extends SwissDelightCore_List_Shortcode {

		public function map_shortcode() {
			$this->set_shortcode_path( SWISSDELIGHT_CORE_PLUGINS_URL_PATH . '/twitter/shortcodes/twitter-list' );
			$this->set_base( 'swissdelight_core_twitter_list' );
			$this->set_name( esc_html__( 'Twitter List', 'swissdelight-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays twitter list', 'swissdelight-core' ) );
			...
			$this->set_option(
				array(
					...
					'field_type' => 'text',
					'title'      => esc_html__( 'Number of Tweets', 'swissdelight-core' ),
					'group'      => esc_html__( 'Info', 'swissdelight-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Retweeted Text', 'swissdelight-core' ),
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Avatar Image', 'swissdelight-core' ),
					'options'       => swissdelight_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'swissdelight-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Author Name', 'swissdelight-core' ),
					'options'       => swissdelight_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'swissdelight-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Tweet Text', 'swissdelight-core' ),
					'options'       => swissdelight_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'swissdelight-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Media Placeholder', 'swissdelight-core' ),
			...
			$this->set_option(
				array(
					'name'          => 'show_date',
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Date', 'swissdelight-core' ),
					'options'       => swissdelight_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'swissdelight-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Tweet Actions', 'swissdelight-core' ),
					'options'       => swissdelight_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'swissdelight-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Twitter Link', 'swissdelight-core' ),
					'options'       => swissdelight_core_get_select_type_options_pool( 'no_yes' ),
					'default_value' => 'no',
					'group'         => esc_html__( 'Info', 'swissdelight-core' ),
				)
		...
		public function render( $options, $content = null ) {
			...
			return swissdelight_core_get_template_part( 'plugins/twitter/shortcodes/twitter-list', 'templates/twitter-list', '', $atts );
		}
