...
?>
<nav class="woocommerce-products-wizard-nav is-pills <?php echo esc_attr(implode(' ', $class))?>"<?php
    ...
    <ul class="woocommerce-products-wizard-nav-list is-pills nav nav-pills" data-component="wcpw-nav-list" role="tablist">
        <?php
