...
echo '<div class="woocommerce-products-wizard-form-layout is-masonry row products" data-component="wcpw-masonry">';
...
echo '<div class="' . $colClass . '" data-component="wcpw-masonry-sizer"></div>';
echo '</div>';
